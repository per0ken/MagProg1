...
int main()
{
	...
	Image h1 {Point{400,100}, "risitas.jpg"};
	win.attach(h1);
	Image h2 {Point{600,300}, "risitas.jpg"};
	win.attach(h2);
	Image h3 {Point{100,400}, "risitas.jpg"};
	win.attach(h3);
	Image h4 {Point{300,600}, "risitas.jpg"};
	win.attach(h4);

	Image kocka {Point{0,0}, "kocka.jpg"};
	win.attach(kocka);
